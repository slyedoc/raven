...
pub trait RayCastExt {
    ...
    fn intersect_triangle(&self, tri: &Tri, tri_index: usize) -> Option<BlasHit>;

    /// Intersect the ray with a BVH, returning the closest hit if any
    fn intersect_bvh(&self, bvh: &Blas) -> Option<BlasHit>;
}
