...
#[type_path = "raven_triplanar_splatting::triplanar_material::TriplanarMaterial"]
...
impl Material for TriplanarMaterial {
    fn vertex_shader() -> ShaderRef {
        ...
        //"embedded://raven_triplanar_splatting/shaders/triplanar_material_vert.wgsl".into()
        "shaders/triplanar_material_vert.wgsl".into()
    }
    fn fragment_shader() -> ShaderRef {        
        //"embedded://raven_triplanar_splatting/shaders/triplanar_material_frag.wgsl".into()
